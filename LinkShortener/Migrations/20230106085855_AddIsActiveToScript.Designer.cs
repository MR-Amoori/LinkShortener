...
namespace LinkShortener.Migrations
{
    ...
    [Migration("20230106085855_AddIsActiveToScript")]
    partial class AddIsActiveToScript
    {
            ...
            modelBuilder.Entity("LinkShortener.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "mohamad021",
                            RegisterDate = new DateTime(2023, 1, 6, 12, 28, 54, 809, DateTimeKind.Local).AddTicks(8819),
