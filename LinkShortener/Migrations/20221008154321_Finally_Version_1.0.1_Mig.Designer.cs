...
namespace LinkShortener.Migrations
{
    ...
    [Migration("20221008154321_Finally_Version_1.0.1_Mig")]
    partial class Finally_Version_101_Mig
    {
            ...
            modelBuilder.Entity("LinkShortener.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "mohamad021",
                            RegisterDate = new DateTime(2022, 10, 8, 19, 13, 20, 696, DateTimeKind.Local).AddTicks(4307),
